...
namespace Acme.FirstProjet.PatientAuth
{
    public class PatientAuthAppService : ApplicationService , IPatientAuthAppService , ITransientDependency
    {
        ...
        public PatientAuthAppService(IConfiguration configuration, IPatientRepository patientRepository, PatientManager patientManager
        ...
        public async Task<Response<LoginDto>> AuthenticateUser(PatientAuthDto input)
        {
            ...
            if (patient is null)
            {
                ...
                IdentityUser newUser = new IdentityUser(GuidGenerator.Create(),username,newEmail,null);
