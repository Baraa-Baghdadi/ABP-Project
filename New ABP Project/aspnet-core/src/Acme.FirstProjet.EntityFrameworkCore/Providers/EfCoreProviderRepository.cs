...
{
    public class EfCoreProviderRepository : EfCoreRepository<FirstProjetDbContext, Provider, Guid>, IProviderRepository
    {
        public EfCoreProviderRepository(IDbContextProvider<FirstProjetDbContext> dbContextProvider) 
