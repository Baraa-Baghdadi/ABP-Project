...
{
    public class EfCorePatientProviderRepository : EfCoreRepository<FirstProjetDbContext, PatientProvider, Guid>, IPatientProviderRepository
    {
        private readonly IDataFilter _dataFilter;
        public EfCorePatientProviderRepository(IDbContextProvider<FirstProjetDbContext> dbContextProvider , IDataFilter dataFilter) : base(dbContextProvider)
        {
