...
{
    public class EfCorePatientRepository : EfCoreRepository<FirstProjetDbContext, Patient, Guid>, IPatientRepository
    {
        public EfCorePatientRepository(IDbContextProvider<FirstProjetDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
