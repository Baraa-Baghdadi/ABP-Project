...
{
    public class EfCorePatientAddressRepository : EfCoreRepository<FirstProjetDbContext, PatientAddress, Guid>, IPatientAddressRepository
    {
        public EfCorePatientAddressRepository(IDbContextProvider<FirstProjetDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
