...
namespace Acme.FirstProjet.QrCode
{
    public class QrCodeService : ITransientDependency
    {
        ...
        {
            string Dawaa24LogoPath = Path.Combine(_Environment.WebRootPath, FirstProjetConsts.EmailingFolderName, _configuration.Value["EmailTemplateSetting:Logo"]);
            var path = Path.Combine(_Environment.WebRootPath, FirstProjetConsts.FilesFolderName);
